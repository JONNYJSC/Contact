...
namespace Contact4.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,NameDepartamento")] Departamento departamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,NameDepartamento")] Departamento departamento)
        {
            if (ModelState.IsValid)
            {
