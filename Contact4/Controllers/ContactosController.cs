...
namespace Contact4.Controllers
{
    public class ContactosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Apellido,Edad")] Contacto contacto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Apellido,Edad")] Contacto contacto)
        {
            if (ModelState.IsValid)
            {
